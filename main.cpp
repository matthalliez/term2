...
void coreFunctions(){
    ...
    std::cout << "Test 3.1: getting value for 'Matt': " << (testMap.get("Matt", value) ? value : "Failed") << std::endl;
    std::cout << "Test 3.2: getting value for 'Calvin': " << (testMap.get("Calvin", value) ? value : "Failed") << std::endl;
}
//clock helper method
double clock(Func&& func){
